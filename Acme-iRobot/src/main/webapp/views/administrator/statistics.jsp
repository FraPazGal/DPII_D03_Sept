...
<table class="displayStyle" style="width:650px; line-height: 30px; font-size: 18px; " >
	...
	<jstl:choose>
		<jstl:when test="${statsIRobotsPerScientist[0] ne null}">
			<tr>
				...
				<td><fmt:formatNumber type="number" minFractionDigits="1" maxFractionDigits="2" value="${statsIRobotsPerScientist[0]}"/> </td>
			</tr>
			
			<tr>
				<td><spring:message code="administrator.statsIRobotsPerScientist.min" /></td>
				<td><fmt:formatNumber type="number" minFractionDigits="1" maxFractionDigits="2" value="${statsIRobotsPerScientist[1]}"/></td>
			</tr>
			
			<tr>
				<td><spring:message code="administrator.statsIRobotsPerScientist.avg" /></td>
				<td> <fmt:formatNumber type="number" minFractionDigits="1" maxFractionDigits="2" value="${statsIRobotsPerScientist[2]}"/></td>
			</tr>
			
			<tr>
				<td><spring:message code="administrator.statsIRobotsPerScientist.stddev" /></td>
				<td> <fmt:formatNumber type="number" minFractionDigits="1" maxFractionDigits="2" value="${statsIRobotsPerScientist[3]}"/></td>
			</tr>
		</jstl:when>
		<jstl:otherwise>
		<tr><td><br></td></tr>
	...
	<tr><td style="text-align: justify; font-size: 22px;font-weight: bold; ">
		<spring:message code="administrator.averageResultsPerFinder" />
	</td></tr>
	<jstl:choose>
		<jstl:when test="${averageResultsPerFinder ne null}">
			<tr>
				...
				<td> <fmt:formatNumber type="number" minFractionDigits="1" maxFractionDigits="2" value="${averageResultsPerFinder}"/></td>
			</tr>
		</jstl:when>
		<jstl:otherwise>
		<tr><td><br></td></tr>
