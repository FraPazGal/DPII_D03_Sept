...
<fieldset style="width: 30%">
	...
	<br>
		...
		<jstl:if test="${!purchase.iRobot.isDeleted and !purchase.iRobot.isDecommissioned}">
			<div>
...
<br>
<input type="button" name="back" value="<spring:message code="mp.back" />" onclick="javascript: relativeRedir('/purchase/list.do')" />&nbsp;
